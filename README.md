...
- **Three difficult examples:**
  1. A short post citing one statistic — could be argument or opinion. I labeled it opinion
     because the stat was decorative rather than part of a real argument.
  2. A recommendation request that also stated a strong preference — labeled question, since
     the main act was asking for input.
  3. A "why does everyone think X" post — labeled opinion, because removing the question mark
     left a clear assertion the poster believed.
